...
Lambda Calculus에 대한 설명과 다이어그램 생성을 통한 직관적 이해.
...
수학적으로 구현된 절차적, 실시간 애니메이션의 구현과 용례.
...
우리 주위 이미지를 빠르게 하는 이미지 압축 알고리즘의 구현과 시각화.
...
개체군의 개체수를 간단하게 측정하는 포획-재포획법을 검증하기 위한 시뮬레이션.
